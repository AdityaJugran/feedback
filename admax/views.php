          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>View Subjects Details <small></small></h2>
                  ...
                  <table id="datatable-fixed-header" class="table table-striped table-bordered">
                    ...
                    ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo $arr['data'][$count]['code']?></td>
                          <td><a href="direction/removef.php?id=<?php echo $arr['data'][$count]['id']?>&sub=1" <button type="submit" class="btn btn-danger fluid" >Remove</button></td>
